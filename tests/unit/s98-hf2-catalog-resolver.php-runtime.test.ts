...
const runnerPath = resolve(process.cwd(), "tests/php/S98Hf2CatalogResolverTestRunner.php");

describe("S98 HF2 catalog resolver php runtime", () => {
  it("selects eşleme successor and fail-closes unrelated overlap", () => {
    ...
    expect(result.stdout).toContain("HF2 catalog resolver unit OK");
  });
});
